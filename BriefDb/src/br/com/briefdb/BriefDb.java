...
public class BriefDb {
    ...
    public static ArrayList query(Connection conn, String query, Object... filter) throws Exception {
     ...
     public static ArrayList query(Connection conn, String query, boolean connectionClose, Object... filter) throws Exception {
        PreparedStatement stm = conn.prepareStatement(query);
        int i = 1;
        if (filter != null) {
            for (Object value : filter) {
    ...
    public static HashMap<Object, Object> crud(Connection conn, int action, String table, String pkName, Object pkValue, HashMap<Object, Object> values, boolean connectionClose) throws Exception {
        HashMap<Object, Object> retuns = new HashMap<>();
        StringBuilder sql = new StringBuilder();
        switch (action) {
            case 1:
